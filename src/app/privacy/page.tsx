...
const PrivacyPolicy: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 py-8 sm:py-16 mt-10 px-2 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto p-2 sm:p-8 md:p-12">
                <header className="mb-6 sm:mb-10">
                    <h1 className="text-3xl sm:text-4xl font-extrabold text-slate-900 mb-2 sm:mb-3">Privacy Policy</h1>
                    <p className="text-xs sm:text-sm text-slate-500">Effective Date: {effectiveDate}</p>
                </header>

                <div className="prose prose-slate max-w-none space-y-8 sm:space-y-10 text-slate-800">
                    <section>
                        <h2 className="text-xl sm:text-2xl font-bold text-slate-900 mb-2 sm:mb-3">1. Introduction</h2>
                    ...
                    <section>
                        <h2 className="text-xl sm:text-2xl font-bold text-slate-900 mb-2 sm:mb-3">2. Information We Collect</h2>
                    ...
                    <section>
                        <h2 className="text-xl sm:text-2xl font-bold text-slate-900 mb-2 sm:mb-3">3. How We Use Your Information</h2>
                        <p className="leading-relaxed mb-2 sm:mb-3 text-sm sm:text-base">
                    ...
                    <section>
                        <h2 className="text-xl sm:text-2xl font-bold text-slate-900 mb-2 sm:mb-3">4. Information We Share</h2>
                        <p className="leading-relaxed mb-2 sm:mb-3 text-sm sm:text-base">
                    ...
                    <section>
                        <h2 className="text-xl sm:text-2xl font-bold text-slate-900 mb-2 sm:mb-3">5. Data Protection & Security</h2>
                        <p className="leading-relaxed text-sm sm:text-base">
                    ...
                    <section>
                        <h2 className="text-xl sm:text-2xl font-bold text-slate-900 mb-2 sm:mb-3">6. Your Rights and Choices</h2>
                        <p className="leading-relaxed mb-2 sm:mb-3 text-sm sm:text-base">
                    ...
                    <section>
                        <h2 className="text-xl sm:text-2xl font-bold text-slate-900 mb-2 sm:mb-3">7. California Consumer Privacy Act (CCPA) Notice</h2>
                        <p className="leading-relaxed text-sm sm:text-base">
                    ...
                    <section>
                        <h2 className="text-xl sm:text-2xl font-bold text-slate-900 mb-2 sm:mb-3">8. Gramm-Leach-Bliley Act (GLBA) Privacy Notice</h2>
                        <p className="leading-relaxed text-sm sm:text-base">
                    ...
                    <section>
                        <h2 className="text-xl sm:text-2xl font-bold text-slate-900 mb-2 sm:mb-3">9. Do Not Sell or Share My Personal Information</h2>
                        <p className="leading-relaxed text-sm sm:text-base">
                    ...
                    <section>
                        <h2 className="text-xl sm:text-2xl font-bold text-slate-900 mb-2 sm:mb-3">10. Contact</h2>
                        <p className="leading-relaxed text-sm sm:text-base">
