...
const Licensing = () => {
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-8 sm:py-12 mt-16 sm:mt-24 px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg p-6 sm:p-8 lg:p-10 border border-gray-200">
                ...
                <div className="space-y-6 sm:space-y-8">
                    <section className="border-l-4 border-blue-500 pl-4 sm:pl-6">
                        <h2 className="text-xl sm:text-2xl font-semibold text-gray-900 mb-2 sm:mb-3">Michigan Licensing</h2>
                    ...
                    <section className="border-l-4 border-green-500 pl-4 sm:pl-6">
                        <h2 className="text-xl sm:text-2xl font-semibold text-gray-900 mb-2 sm:mb-3">Licensed States</h2>
                        ...
                        <ul className="space-y-2">
                            <li className="flex items-start">
                                ...
                                <span className="text-gray-700 text-base sm:text-lg">Colorado (CO)</span>
                            </li>
                        </ul>
                    </section>

                    <section className="border-l-4 border-indigo-500 pl-4 sm:pl-6">
                        <h2 className="text-xl sm:text-2xl font-semibold text-gray-900 mb-2 sm:mb-3">NMLS Information</h2>
                        <p className="text-gray-700 leading-relaxed text-sm sm:text-base">
